...
import { FaEnvelope, FaPhone, FaGithub, FaLinkedin, FaFilePdf } from 'react-icons/fa';
            ...
            <div className="flex flex-col items-center">
              ...
              <div className="mt-4 w-full">
                ...
                <div className="flex items-center">
                  <FaFilePdf className="text-blue-800 mr-2" />
                  <a href={getAssetPath("zhuoyangzou.pdf")} target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">
                    Resume (PDF)
                  </a>
                </div>
              </div>
