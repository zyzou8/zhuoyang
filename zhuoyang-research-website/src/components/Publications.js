...
const publications = [
  {
    ...
    year: "2026",
    arxiv: null,
    pdf: "https://www.scitepress.org/Papers/2026/150898/150898.pdf",
...
export default function Publications() {
  return (
    <section id="publications" className="bg-white rounded-lg shadow-md p-6">
      <h2 className="text-2xl font-bold text-gray-800 mb-6 border-b border-gray-200 pb-2">Publications</h2>
          ...
          <div key={index} className="flex gap-4 group">
            ...
            <div className="flex-1 min-w-0">
              <a
                ...
                className="text-base font-semibold text-gray-900 hover:text-gray-600 hover:underline leading-snug"
              >
                {pub.title}
              </a>
